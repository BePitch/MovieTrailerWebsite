...
harry_potter = media.Movie("Harry Potter and the Deathly Hallows Part 2",
                     "Fantasy movie that takes place in the real world about a group of kids",
                     "https://upload.wikimedia.org/wikipedia/en/d/df/"
                           "Harry_Potter_and_the_Deathly_Hallows_%E2%80%93_Part_2.jpg",
                     "https://www.youtube.com/watch?v=9hXH0Ackz6w"
                     )
# Movie #4
step_brothers = media.Movie("Step Brothers",
                     "a comedy about the most amazing friendship that would"
                            "spawn out of the most uncertain circumstances.",
